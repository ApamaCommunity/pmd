...
// Start Rules
//----------------------------------------------------------------------------
startPatternExpressionRule : (moduleDecl | annotationEnum | expressionDecl)* patternExpression EOF;
	
startEPLExpressionRule : (moduleDecl | annotationEnum | expressionDecl)* eplExpression EOF;
